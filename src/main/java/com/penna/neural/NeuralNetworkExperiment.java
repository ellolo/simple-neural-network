...
import com.penna.neural.common.DatasetReader;
import com.penna.neural.common.DoubleMatrixUtils;
import com.penna.neural.common.Instance;
import com.penna.neural.common.Dataset;
...
public class NeuralNetworkExperiment {
    ...
    private static int evaluateInstanceAsClassification(NeuralNetwork nn, Instance instance) {
        // try{
    ...
    private static double evaluateTestSetAsClassification(NeuralNetwork nn, Dataset testSet) {
        Instance instance;
        double precision = 0d;
    ...
    public static void experiment(Dataset trainingSet, Dataset testSet, int[] layerSizes,
            int epochs, double eta, int miniBatchSize) throws NetworkInitializationException {
    ...
    public static void main(String[] argv) throws IOException, NetworkInitializationException{
        ...
        Dataset trainingSet = DatasetReader.readMNISTdata(labelFileTr, imageFileTr);
        Dataset testSet = DatasetReader.readMNISTdata(labelFileTe, imageFileTe);
