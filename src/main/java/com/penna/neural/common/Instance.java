...
/**
 * An Instance is an input object to the neural network. If the instance has labels, then it can be
 * used to train or test the neural network. For binary classification, labels are a 1x1 matrix.
 * For n-class classification they are typically a nx1 matrix.
 * 
