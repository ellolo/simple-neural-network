...
/**
 * Dummy experiment create fictitiuos instances and training a network. Goal of this example is to
...
public class DummyExperiment {
    ...
    public static void main(String[] argv) throws NetworkInitializationException {
        ...
        Instance trainingIns1 = new Instance(new DoubleMatrix(new double[][] { { 1.0 }, { -0.5 }, { 3.0 } }), new DoubleMatrix(new double[][] { { 0.1 }, { 0.8 }, { 0.05 }, { 0.05 } }));
        Instance trainingIns2 = new Instance(new DoubleMatrix(new double[][] { { 0.0 }, { 7.0 }, { -0.5 } }), new DoubleMatrix(new double[][] { { 0.0 }, { 0.0 }, { 0.1 }, { 0.9 } }));
